...
public class QuadrupedalAgent : Agent
{
    ...
    ObstacleSpawner MySpawner;

    public Vector3 sum = new Vector3(0, 0, 0);
    ...
    public override void Initialize()
    {
        ...
        MySpawner = spawner.GetComponent<ObstacleSpawner>();
    ...
    {
        MySpawner.CleanObstacles();
        MySpawner.SpawnObstacles();
